...
function Ut() {
  if (lt)
    return He;
  lt = 1;
  var J = pt(), y = Symbol.for("react.element"), Ee = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = J.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, $, Z) {
...
var Bt = Nr.exports;
function zt() {
  return /* @__PURE__ */ Bt.jsx("button", { onClick: () => {
    alert("hello form plugin");
  } });
}
const qt = ctx.timerCard.injector, Ht = qt.get("timerDisplay");
Ht.updateTimerDisplay(zt);
